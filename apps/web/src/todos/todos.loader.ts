...
/** loader が API に渡してよいクエリ。DTO（ListTodosQueryDto）に無いキーを送ると 400 になる。 */
const FORWARDED_QUERY_KEYS = ['status', 'q', 'page'] as const;
...
export async function todosLoader({
  request,
}: LoaderFunctionArgs): Promise<ListTodosResponse> {
